/* =========================================================================
   MIZTWEAKZ. Site data
   -------------------------------------------------------------------------
   Every piece of store content lives here so the header/footer/modals in
   site.js and the Phase B pages can all render from one source of truth.
   Load this BEFORE site.js:  <script src="/assets/js/data.js" defer></script>

   Shape:
     MZ.brand      . Names, tagline, announcement, socials, emails, URLs
     MZ.nav        . Header/footer navigation (order matters)
...
(function () {
  ...
  var MZ = {
    ...
    /* Header / footer navigation. `dropdown: 'categories'` renders one entry
       per MZ.categories item under the tab (Paragon's Services hover panel). */
    /* Free download used by every "Download for Free" button: the real MizTweakz installer. Cross-origin, so no download attribute. */
    download: { href: 'https://github.com/austins041/MizTweakz/releases/latest/download/MizTweakz-Setup.exe', label: 'Download for Free' },
    nav: [
